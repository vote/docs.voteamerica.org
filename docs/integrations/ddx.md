...
You can sync information between VoteAmerica Plus and other tools you use for organizing and outreach 
...
* **Data owner** - That's you. You own the data collected via your instance of VoteAmerica Plus tools.
* **Data source** - That's us. VoteAmerica Plus is the data source that collects information from users via your tools.
...
2. Generate a DDx API key that authorizes VoteAmerica Plus to push interactions to your DDx account. 
...
3. In the VoteAmerica Plus dashboard, navigate to the [Company Settings](https://secure.voteamericaplus.org/settings/) page and scroll to "Third-party integrations".
4. Check the box "Enable DDx Sync", then paste your DDx API key and organization name into the provided fields. Click "Save".

## Interactions

Each time a user submits a form on your instance of the VoteAmerica Plus tools, VoteAmerica Plus will push an "interaction". 
