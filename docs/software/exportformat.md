...
This document contains the column names and descriptions for exports available via the [VoteAmericaPlus customer portal](https://secure.voteamerica.org/export/).
