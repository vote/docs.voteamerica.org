...
This document contains the column names and descriptions for exports available via the [VoteAmerica Plus customer portal](https://secure.voteamericaplus.org/export/).
