...
This document contains the column names and descriptions for data synced from VoteAmerica Plus to TMC's data warehouse 
...
The sync is available for these VoteAmerica Plus tools:
